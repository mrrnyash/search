...
Revision ID: b7437e904ffd
Revises: 
Create Date: 2022-06-19 13:43:05.006734
...
def upgrade():
    ...
    op.create_table('document_lending_log',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('count', sa.Integer(), nullable=True),
    sa.Column('date', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['id'], ['record.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    ...
    op.drop_table('document_lending_log')
    op.drop_table('user')

...
Revision ID: 873456379c56
Revises: 
Create Date: 2022-04-26 20:49:57.930077
...
def upgrade():
    ...
    op.create_table('records_doctypes',
    ...
    sa.ForeignKeyConstraint(['record_id'], ['record.id'], onupdate='CASCADE', ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('doctype_id', 'record_id')
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('records_doctypes')
